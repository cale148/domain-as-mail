...
docker-compose run --rm app gulp --cordova 'build --release android' --env=prod
...
zipalign -v 4 dasm/platforms/android/build/outputs/apk/android-release-unsigned.apk dasm.$(git describe --tags).apk
